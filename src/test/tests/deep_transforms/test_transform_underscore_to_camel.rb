...
class TestTransformUnderscoreToCamel < BaseTest
  ...
  def test_array_transform_shallow
    ...
    expected_value = [{keyName1: 1, keyName2: 2}, {keyName3: 3, keyName4: 4}]
  ...
  def test_array_transform_deep
    ...
    expected_value = [[[[[{keyName1: 1}, {keyName2: [[[{keyName3: 3}]]]}]]]]]
  ...
  def test_hash_transform_deep
    ...
    expected_value = {keyName1: 1, keyName2: {keyName3: {keyName4: {keyName5: 5}}}}
  ...
  def assert_initial_value_is_transformed_to_expected_value(initial_value, expected_value)
    assert_equal expected_value, HashKeyTransformer.transform_underscore_to_camel(initial_value)
  end

  def assert_transformed_value_is_equal(value)
    assert_equal value, HashKeyTransformer.transform_underscore_to_camel(value)
  end
